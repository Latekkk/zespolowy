...
class PointService {
    async getPoints(paginate: number = 15, page: number = 1, sort: string = 'id', sortOrder: number = 0 , selectedMountainMain: null): Promise<Point[]> {
        const API_URL_GET_POINTS = route('api.points.index');

        const params = { params: { paginate, page, sort, sortOrder, selectedMountainMain } };
